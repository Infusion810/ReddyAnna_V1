...
const LoginPage = () => {
  ...
  return (
    <LoginPageContainer>
      <LoginFormContainer>
        <Logo>
          {/* <BrandHeading>98FASTBET</BrandHeading> */}
          <img src="./logo-txt.png" className='logo-name' alt="Logo" />
        </Logo>
        ...
        {/* <div className="footer">
          Powered by <strong>ReddyAnna</strong>{' '}
          <a href="mailto:reddybook.clubofficial@gmail.com">ReddyAnna.official@gmail.com</a>
        </div> */}
      </LoginFormContainer>
    </LoginPageContainer>
  );
...
const LoginFormContainer = styled.div`
  ...
  padding: clamp(1.5rem, 4vw, 2.5rem);
      background: linear-gradient(135deg, #C11A1A 0%, #FF5555 100%);
  color: #fff;
  border-radius: 15px;
